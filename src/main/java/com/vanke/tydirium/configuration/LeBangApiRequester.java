...
import com.vanke.tydirium.utils.HttpUtil;
...
public class LeBangApiRequester {
	...
	public String requestAccessToken(String code) throws Exception {
		...
		return HttpUtil.sendPost(lebang_api_host + token_uri, params, null);
	}
	...
	public String requestUserInfo(String accessToken) throws Exception {
		return HttpUtil.sendGet(lebang_api_host + info_url + "?access_token=" + accessToken);
	}
	...
	public List<Entry<String, String>> requestUserJobs(String accessToken) throws Exception {
		...
		String response = HttpUtil.sendGet(lebang_api_host + jobs_url + "?access_token=" + accessToken);
