...
;!function(e) {
    ...
    t.fn.define = function(e, t) {
        ...
        return i && (t = e, e = []),
        layui["layui.all"] || !layui["layui.all"] && layui["layui.mobile"] ? r.call(n) : (n.use(e, r), n)
    },
    t.fn.use = function(e, t, u) {
        ...
        function c() {
            u.push(layui[m]),
            e.length > 1 ? f.use(e.slice(1), t, u) : "function" == typeof t && t.apply(layui, u)
        }
        var f = this,
        ...
        var m = e[0],
        v = 0;
        if (u = u || [], o.host = o.host || (d.match(/\/\/([\s\S]+?)\//) || ["//" + location.host + "/"])[0], 0 === e.length || layui["layui.all"] && a[m] || !layui["layui.all"] && layui["layui.mobile"] && a[m]) return c(),
        f;
    ...
    t.fn.link = function(e, t, i) {
        ...
        f = 0;
        a.rel = "stylesheet",
        a.href = e + (o.debug ? "?v=" + (new Date).getTime() : ""),
        a.media = "all",
        n.getElementById(c) || u.appendChild(a),
        "function" == typeof t && !
        function d() {
    ...
    t.fn.event = function(e, t, n) {
        ...
        return layui.each(o.event[a], u),
        l[0] && layui.each(o.event[t], u),
        r
    },
    e.layui = new t
} (window);
...
layui.define(function(e) {
    ...
    t.pt.parse = function(e, t) {
        ...
        a = c("^" + r.open + "#", ""),
        l = c(r.close + "$", "");
        e = e.replace(/\s+|\r|\t|\n/g, " ").replace(c(r.open + "#"), r.open + "# ").replace(c(r.close + "}"), "} " + r.close).replace(/\\/g, "\\\\").replace(/(?="|')/g, "\\").replace(n.query(),
        function(e) {
...
layui.define(function(e) {
    ...
    layui.addcss("modules/laydate/laydate.css",
    function() {},
    "laydatecss"),
    e("laydate", laydate)
}); !
...
function(e, t) {
    ...
    function y(e, t, n, r, i) {
        for (var o, a, s, u, l, c, f, d = e.length,
        y = p(t), v = [], x = 0; x < d; x++) if (a = e[x], a || 0 === a) if ("object" === pe.type(a)) pe.merge(v, a.nodeType ? [a] : a);
        else if (Ue.test(a)) {
    ...
    pe.extend = pe.fn.extend = function() {
        ...
        s++), "object" == typeof a || pe.isFunction(a) || (a = {}), s === u && (a = this, s--); s < u; s++) if (null != (i = arguments[s])) for (r in i) e = a[r],
        n = i[r],
    ...
    pe.fn.extend({
        ...
        closest: function(e, t) {
            for (var n, r = 0,
            i = this.length,
            o = [], a = we.test(e) || "string" != typeof e ? pe(e, t || this.context) : 0; r < i; r++) for (n = this[r]; n && n !== t; n = n.parentNode) if (n.nodeType < 11 && (a ? a.index(n) > -1 : 1 === n.nodeType && pe.find.matchesSelector(n, e))) {
                o.push(n);
                break
            }
    ...
    pe.event = {
        ...
        add: function(e, t, n, r, i) {
            ...
            if (m) {
                ...
                c.elem = e), t = (t || "").match(De) || [""], s = t.length; s--;) o = Qe.exec(t[s]) || [],
                p = g = o[1],
                h = (o[2] || "").split(".").sort(),
    ...
    function(e, t) {
        pe.fn[e] = function(e) {
            for (var n, r = 0,
            i = [], o = pe(e), a = o.length - 1; r <= a; r++) n = r === a ? this: this.clone(!0),
            pe(o[r])[t](n),
            ae.apply(i, n.get());
    ...
    pe.cssHooks.marginRight = L(fe.reliableMarginRight,
    function(e, t) {
        if (t) return dt(e, {
    ...
    pe.cssHooks.marginLeft = L(fe.reliableMarginLeft,
    function(e, t) {
        ...
        valHooks: {
            ...
            select: {
                get: function(e) {
                    ...
                    a = o ? null: [], s = o ? i + 1 : r.length, u = i < 0 ? s: o ? i: 0; u < s; u++) if (n = r[u], (n.selected || u === i) && (fe.optDisabled ? !n.disabled: null === n.getAttribute("disabled")) && (!n.parentNode.disabled || !pe.nodeName(n.parentNode, "optgroup"))) {
    ...
    fe.hrefNormalized || pe.each(["href", "src"],
    function(e, t) {
        pe.propHooks[t] = {
            get: function(e) {
    ...
    pe.extend({
        ...
        ajax: function(t, n) {
            ...
            n = n || {};
            var i, o, a, s, u, l, c, f, d = pe.ajaxSetup({},
            n),
            p = d.context || d,
    ...
    pe.each(["top", "left"],
    function(e, t) {
        pe.cssHooks[t] = L(fe.pixelPosition,
        function(e, n) {
...
function(i) {
    ...
    s.prototype.tabAdd = function(i, t) {
        ...
        return n.append('<li lay-id="' + (t.id || "") + '">' + (t.title || "unnaming") + "</li>"),
    ...
    f = {
        ...
        tabDelete: function(i, t) {
            ...
            l.hasClass(e) && (l.next()[0] ? f.tabClick.call(l.next()[0], null, n + 1) : l.prev()[0] && f.tabClick.call(l.prev()[0], null, n - 1)),
            l.remove(),
            o.eq(n).remove(),
            setTimeout(function() {
                f.tabAuto()
        ...
        var l = {
            ...
            nav: function() {
                ...
                a(o).each(function() {
                    ...
                    y = t.find("." + c);
                    t.find("." + r)[0] || (t.append(o), y.on("mouseenter",
                    function() {
                        p.call(this, o, t)
                    }).on("mouseleave",
                    function() {
                        t.hasClass(u) || (clearTimeout(l), l = setTimeout(function() {
                            t.find("." + d).removeClass(n),
                            t.find("." + h).removeClass(h + "d")
                        },
                        300))
                    }), t.on("mouseleave",
                    function() {
                    ...
                    y.each(function() {
                        ...
                        t.children("dd").off("click", f.clickChild).on("click", f.clickChild)
                    })
                })
            },
            breadcrumb: function() {
            ...
            collapse: function() {
                ...
                a("." + i).each(function() {
                    ...
                    i.each(function() {
                        ...
                        t.off("click", f.collapse).on("click", f.collapse)
                    })
                })
            }
        };
    ...
    v.on("click", b, f.tabClick),
    v.on("click", f.hideTabMore),
...
function(l) {
    ...
    i = {
        fixbar: function(l) {
            l = l || {},
            l.bgcolor = l.bgcolor ? "background-color:" + l.bgcolor: "";
            ...
            o(".layui-fixbar")[0] || ("object" == typeof l.css && r.css(l.css), o("body").append(r), s(), r.find("li").on("click",
            function() {
                var i = o(this),
                a = i.attr("lay-type");
                ...
                200),
                l.click && l.click.call(this, a)
            }), o(document).on("scroll",
            function() {
                i && clearTimeout(i),
                i = setTimeout(function() {
                    s()
